...
// 	const r = await fetch("https://planetterp.com/api/v1/course?name=CMSC335");
// 	let r2 = await r.json();
// 	console.log(r2.average_gpa);
...
// 			}
// 		});
// 		gpa = totalCredits > 0 ? (totalPoints / totalCredits).toFixed(2) : "N/A";
// 	} catch (err) {
// 		console.error(err);
